...
<head>
	...
	<link rel="icon" type="x-icon" href="aa.PNG">
	<link href="https://fonts.googleapis.com/css?family=Quicksand&display=swap" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
	<title>Amrit Prakash </title>
</head>
</head>
<body>
	<nav class="navbar sticky-top navbar-expand-sm navbar-dark bg-dark">
		<a class="navbar-brand" href="home.php">
    	<img src="aa.PNG" width="150" height="80" class="d-inline-block align-middle" alt=""> Hello Welcome to my College Predictor Website , Created by AMRIT PRAKASH </a>
  <!-- Links -->
	...
	<div class="background">
		...
		<form method="post" action="home.php">
			<div id="center">
				...
				<input class="ip" type="text" name="srm" placeholder="ITER Score"><br><br>
			...
			if(isset($_POST['submit']))
			{
				...
				if($_SERVER["REQUEST_METHOD"] == "POST")
				{
					...
					else
					{
						...
						if($bits>280)
							echo "You are eligible to apply for Birla institute of technology and science <br>";
						if($srm>140)
							echo "You are eligible to apply for Institute of Technical Education and Research<br>";
						if($vit>80)
